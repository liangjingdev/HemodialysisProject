 ...
 */
public class SchedulingAppointmentFragment extends BaseFragment implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected int setLayoutResourceID() {
        return R.layout.fragment_scheduling_appointment_layout;
    }
    ...
    protected void initEvents() {
        ...
        mAdapter = new AdapterForRecyclerView<String>(getContext(), mData, R.layout.item_scheduling_appointment_doctor_layout) {
            @Override
            public void convert(ViewHolderForRecyclerView holder, String item, int position) {
                holder.setText(R.id.orderDate, item);
                holder.setText(R.id.orderShift,item);
                holder.setText(R.id.orderTime,item);
                holder.setText(R.id.nurse,item);
            }
        };
