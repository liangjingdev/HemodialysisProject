 ...
 *
 * function：网络工具类,用于判断当前网络是否可用，以及获取当前的网络状态。(处于什么网络)
 */

public class NetworkUtil {

    public static int NET_WORK_OK = 1; // NetworkAvailable
    public static int NET_WORK_TIMEOUT = 2; // no NetworkAvailable
    ...
    /**
     * function:check NetworkAvailable(检查网络是否可用)
     * @param context
     * @return
     */
    ...
    /**
     * function:getLocalIpAddress(返回当前的ip地址)
     * @return
     */
